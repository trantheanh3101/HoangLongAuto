                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item active">
                            <a class="nav-link text-white" href="showroom?action=filterUser&type=all">All</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="showroom?action=filterUser&type=new">New Cars</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="showroom?action=filterUser&type=old">Old Cars</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="#">Sales Cars</a>
                        </li>
                    </ul>
                    <form class="d-flex" method="post" action="showroom?action=searchHomeUser">
                        <input class="form-control me-3" type="search" placeholder="Search" aria-label="Search" id="searchHomeUser" name="searchHomeUser">
